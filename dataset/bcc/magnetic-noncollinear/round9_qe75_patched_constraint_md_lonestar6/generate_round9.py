#!/usr/bin/env python3
"""Generate paired patched-QE 7.5 noncollinear MD pilots for Round 9."""
...
ROUND8 = ROOT.parent / "round8_qe75_patched_constraint_lonestar6"
...
CASES = (
    ("a2p39_m2_lambda0p050_md10", (0.005, 0.020, 0.050)),
    ("a2p39_m2_lambda0p100_md10", (0.005, 0.020, 0.100)),
)
STAGES = (
...
def main() -> None:
    ...
    source_pseudo = ROUND8 / "pseudo" / PSEUDO
    ...
    for serial_index, (case, path) in enumerate(CASES):
        ...
        row = {
            ...
            "md_steps": 10, "velocity_seed": 400054,
    ...
    print(f"Generated {len(rows)} Round-9 cases with identical positions and velocities")
