#!/usr/bin/env python3
"""Generate the patched-QE 7.5 noncollinear 50-step Round-10 pilot."""
...
ROUND9 = ROOT.parent / "round9_qe75_patched_constraint_md_lonestar6"
...
CASES = (
    ("a2p39_m2_lambda0p100_md50", (0.005, 0.020, 0.100)),
)
STAGES = (
...
def main() -> None:
    ...
    source_pseudo = ROUND9 / "pseudo" / PSEUDO
    ...
    for serial_index, (case, path) in enumerate(CASES):
        ...
        row = {
            ...
            "md_steps": 50, "velocity_seed": 400054,
    ...
    print(f"Generated {len(rows)} Round-10 50-step case with thermalized positions and velocities")
