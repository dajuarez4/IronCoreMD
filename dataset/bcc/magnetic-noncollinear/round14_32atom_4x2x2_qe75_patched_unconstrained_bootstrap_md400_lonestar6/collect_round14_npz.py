#!/usr/bin/env python3
"""Collect Round-14 SCF/MD400 results into a lightweight safe NPZ archive."""
...
SCHEMA = "ironcoremd.qe.bcc32_patched_qe75_lambda0p100_md400_round14.v1"
NATOMS = 32
...
def main() -> None:
    ...
    parser.add_argument("-o", "--output", type=Path, default=ROOT / "round14_results_light.npz")
    ...
    support = [path for path in (ROOT / "README.md", ROOT / "case_manifest.csv", ROOT / "velocity_summary.json",
                                  ...
                                  ROOT / "run_round14_lonestar6.sbatch", ROOT / "check_round14.sh",
                                  ROOT / "plot_round14.sh", ROOT / "generate_round14.py") if path.is_file()]
