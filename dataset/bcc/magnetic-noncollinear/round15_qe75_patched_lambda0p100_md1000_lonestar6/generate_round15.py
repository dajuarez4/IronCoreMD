#!/usr/bin/env python3
"""Generate the patched-QE 7.5 noncollinear 1000-step Round-15 run."""
...
CASES = (
    ("a2p39_m2_lambda0p100_md1000", (0.005, 0.020, 0.100)),
)
STAGES = (
...
def main() -> None:
    ...
    for serial_index, (case, path) in enumerate(CASES):
        ...
        row = {
            ...
            "md_steps": 1000, "velocity_seed": 400054,
    ...
    print(f"Generated {len(rows)} Round-15 1000-step case with thermalized positions and velocities")
