#!/usr/bin/env python3
"""Collect Round-11 SCF/MD400 results into a lightweight safe NPZ archive."""
...
SCHEMA = "ironcoremd.qe.bcc8_patched_qe75_lambda0p100_md400_round11.v1"
NATOMS = 8
...
def main() -> None:
    ...
    parser.add_argument("-o", "--output", type=Path, default=ROOT / "round11_results_light.npz")
    ...
    support = [path for path in (ROOT / "README.md", ROOT / "case_manifest.csv", ROOT / "velocity_summary.json",
                                  ROOT / "run_round11_lonestar6.sbatch", ROOT / "check_round11.sh",
                                  ROOT / "plot_round11.sh", ROOT / "generate_round11.py") if path.is_file()]
