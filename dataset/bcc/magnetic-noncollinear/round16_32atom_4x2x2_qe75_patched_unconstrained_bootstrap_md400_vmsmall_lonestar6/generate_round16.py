#!/usr/bin/env python3
"""Generate the Round-16 vm-small copy of the Round-14 32-atom workflow."""
...
def main() -> None:
    ...
    prefix = "Fe_bcc32_r16_a2p39_4x2x2_m2_l0100_md400"
    ...
    print("Generated one Round-16 vm-small unconstrained-bootstrap BCC 4x2x2 32-atom case")
